...
const Test DefaultTests::MISMATCHED_DUP_IDS          = {"No mis-matched duplicate IDs", "lc -m all", "General"};
...
const Test DefaultTests::NO_DUPLICATE_ID             = {"Duplicate ID check", "lc -d all","General"};
const Test DefaultTests::NO_MATRICES                 = {"No matrices", "search /all ! -matrix IDN", "General"};
