...
void MainWindow::prepareUi()
{
    ...
    QIcon newActIcon;
    newActIcon.addPixmap(
        QPixmap::fromImage(coloredIcon(":/icons/sharp_note_add_black_48dp.png", "$Color-MenuIconFile")), QIcon::Normal);
    newActIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/sharp_note_add_black_48dp.png", "$Color-Menu")),
                         QIcon::Active);
    ...
    QIcon openActIcon;
    openActIcon.addPixmap(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_folder_black_48dp.png", "$Color-MenuIconFile")),
        QIcon::Normal);
    openActIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/baseline_folder_black_48dp.png", "$Color-Menu")),
                          QIcon::Active);
    ...
    QIcon saveActIcon;
    saveActIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/sharp_save_black_48dp.png", "$Color-MenuIconFile")),
                          QIcon::Normal);
    saveActIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/sharp_save_black_48dp.png", "$Color-Menu")),
                          QIcon::Active);
    ...
    QIcon saveAsActIcon;
    saveAsActIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/saveAsIcon.png", "$Color-MenuIconFile")),
                            QIcon::Normal);
    ...
    QIcon quitActIcon;
    quitActIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/quitIcon.png", "$Color-MenuIconQuit")),
                          QIcon::Normal);
    QAction *quitAct = new QAction(quitActIcon, tr("Quit"), this);
    quitAct->setShortcut(QKeySequence(tr("Ctrl+Q")));
    quitAct->setStatusTip(tr("Quit"));
    connect(quitAct, &QAction::triggered, this, [this]() { QCoreApplication::quit(); });
    ...
    connect(createArb8Act, &QAction::triggered, this, [this]() {
        ...
        QString name;
        if (!getObjectNameFromUser(this, *documents[activeDocumentId], name))
            return;
    ...
    connect(relativeMoveAct, &QAction::triggered, this, [this]() {
        if (activeDocumentId == -1)
            return;
        if (documents[activeDocumentId]->getObjectTreeWidget()->currentItem() == nullptr)
            return;
        int objectId = documents[activeDocumentId]->getObjectTreeWidget()->currentItem()->data(0, Qt::UserRole).toInt();
        MatrixTransformWidget *matrixTransformWidget =
            new MatrixTransformWidget(documents[activeDocumentId], objectId, MatrixTransformWidget::Translate);
    });
    ...
    connect(relativeScaleAct, &QAction::triggered, this, [this]() {
        ...
        int objectId = documents[activeDocumentId]->getObjectTreeWidget()->currentItem()->data(0, Qt::UserRole).toInt();
        MatrixTransformWidget *matrixTransformWidget =
            new MatrixTransformWidget(documents[activeDocumentId], objectId, MatrixTransformWidget::Scale);
    });
    ...
    connect(relativeRotateAct, &QAction::triggered, this, [this]() {
        ...
        int objectId = documents[activeDocumentId]->getObjectTreeWidget()->currentItem()->data(0, Qt::UserRole).toInt();
        MatrixTransformWidget *matrixTransformWidget =
            new MatrixTransformWidget(documents[activeDocumentId], objectId, MatrixTransformWidget::Rotate);
    });
    ...
    resetViewportAct->setStatusTip(
        tr("Reset to default camera orientation for the viewport and autoview to currently visible objects"));
    connect(resetViewportAct, &QAction::triggered, this, [this]() {
        if (activeDocumentId == -1)
            return;
        documents[activeDocumentId]->getViewportGrid()->resetViewPort(
            documents[activeDocumentId]->getViewportGrid()->getActiveViewportId());
    });
    viewMenu->addAction(resetViewportAct);

    QAction *resetAllViewportsAct = new QAction("Reset all viewports", this);
    resetAllViewportsAct->setIcon(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_refresh_black_48dp.png", "$Color-MenuIconView")));
    resetAllViewportsAct->setStatusTip(
        tr("Reset to default camera orientation for each viewport and autoview to visible objects"));
    ...
    autoViewAct->setIcon(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_crop_free_black_48dp.png", "$Color-MenuIconView")));
    ...
    centerViewAct->setIcon(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_center_focus_strong_black_48dp.png", "$Color-MenuIconView")));
    ...
    toggleGridAct->setIcon(
        QPixmap::fromImage(coloredIcon(":/icons/sharp_grid_on_black_48dp.png", "$Color-MenuIconView")));
    ...
    connect(themeAct[0], &QAction::triggered, this, [this]() {
        ...
        QMessageBox::information(this, "Application Restart Needed",
                                 "Selected theme will be set after next restart of Arbalest", QMessageBox::Ok);
    });
    ...
    raytraceAct->setIcon(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_filter_vintage_black_48dp.png", "$Color-MenuIconRaytrace")));
    ...
    connect(aboutAct, &QAction::triggered, this, [this]() { (new AboutWindow())->show(); });
    ...
    minimizeButton->setIcon(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_minimize_white_36dp", "$Color-WindowTitleButtons")));
    ...
    {
        maximizeButton->setIcon(QPixmap::fromImage(
            coloredIcon(":/icons/sadeep_edited_baseline_crop_din_white_36dp.png", "$Color-WindowTitleButtons")));
    }
    else
    {
        maximizeButton->setIcon(
            QPixmap::fromImage(coloredIcon(":/icons/baseline_crop_din_white_36dp.png", "$Color-WindowTitleButtons")));
    }
    ...
    closeButton->setIcon(QPixmap::fromImage(
        coloredIcon(":/icons/sadeep_edited_baseline_close_white_36dp", "$Color-WindowTitleButtons")));
    ...
    QIcon newButtonIcon;
    newButtonIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/sharp_note_add_black_48dp.png", "$Color-IconFile")),
                            QIcon::Normal);
    ...
    openButtonIcon.addPixmap(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_folder_black_48dp.png", "$Color-IconFile")), QIcon::Normal);
    ...
    saveButtonIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/sharp_save_black_48dp.png", "$Color-IconFile")),
                             QIcon::Normal);
    ...
    saveAsButtonIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/saveAsIcon.png", "$Color-IconFile")),
                               QIcon::Normal);
    ...
    QIcon focusAllIcon;
    focusAllIcon.addPixmap(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_crop_free_black_48dp.png", "$Color-IconView")), QIcon::Normal);
    ...
    focusCurrentIcon.addPixmap(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_center_focus_strong_black_48dp.png", "$Color-IconView")),
        QIcon::Normal);
    ...
    resetViewportsIcon.addPixmap(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_refresh_black_48dp.png", "$Color-IconView")), QIcon::Normal);
    ...
    connect(currentViewport, QOverload<int>::of(&QComboBox::activated), [=](int index) {
        if (activeDocumentId == -1)
            return;
        if (index < 4)
            documents[activeDocumentId]->getViewportGrid()->singleViewportMode(index);
        else
            documents[activeDocumentId]->getViewportGrid()->quadViewportMode();
        for (QAction *i : singleViewAct)
            i->setChecked(false);
        if (index != 4)
            singleViewAct[index]->setChecked(true);
    });
    ...
    toggleGridIcon.addPixmap(QPixmap::fromImage(coloredIcon(":/icons/sharp_grid_on_black_48dp.png", "$Color-IconView")),
                             QIcon::Normal);
    ...
    selectObjectButtonIcon.addPixmap(
        QPixmap::fromImage(coloredIcon(":/icons/select_object.png", "$Color-IconSelectObject")), QIcon::Normal);
    ...
    raytraceButtonIcon.addPixmap(
        QPixmap::fromImage(coloredIcon(":/icons/baseline_filter_vintage_black_48dp.png", "$Color-IconRaytrace")),
        QIcon::Normal);
...
void MainWindow::newFile()
{
    ...
    connect(documents[activeDocumentId]->getObjectTreeWidget(), &ObjectTreeWidget::selectionChanged, this,
            &MainWindow::objectTreeWidgetSelectionChanged);
}
...
void MainWindow::openFileDialog()
{
    const QString filePath =
        QFileDialog::getOpenFileName(documentArea, tr("Open BRL-CAD database"), QString(), "BRL-CAD Database (*.g)");
    if (!filePath.isEmpty())
    {
        openFile(filePath);
    }
...
void MainWindow::saveAsFileDialog()
{
    if (activeDocumentId == -1)
        return;
    const QString filePath =
        QFileDialog::getSaveFileName(this, tr("Save BRL-CAD database"), QString(), "BRL-CAD Database (*.g)");
    if (!filePath.isEmpty())
    {
...
bool MainWindow::maybeSave(int documentId, bool *cancel)
{
    ...
    {
        QFileInfo pathName(documents[documentId]->getFilePath() != nullptr ? *documents[documentId]->getFilePath()
                                                                           : "Untitled");
...
void MainWindow::onActiveDocumentChanged(const int newIndex)
{
    ...
    if (displayGrid != nullptr)
    {
        if (displayGrid->getDocument()->getDocumentId() != activeDocumentId)
        {
            ...
            statusBarPathLabel->setText(documents[activeDocumentId]->getFilePath() != nullptr
                                            ? *documents[activeDocumentId]->getFilePath()
                                            : "Untitled");
...
void MainWindow::changeEvent(QEvent *e)
{
    if (e->type() == QEvent::WindowStateChange)
    {
        ...
        {
            maximizeButton->setIcon(QPixmap::fromImage(
                coloredIcon(":/icons/baseline_crop_din_white_36dp.png", "$Color-WindowTitleButtons")));
        }
    }
}
