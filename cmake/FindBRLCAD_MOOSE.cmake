...
IF(CMAKE_LINK_LIBRARY_SUFFIX)
    FIND_PATH(BRLCAD_MOOSE_LIBRARY_DIR NAMES "brlcad${CMAKE_LINK_LIBRARY_SUFFIX}" "libbrlcad${CMAKE_LINK_LIBRARY_SUFFIX}" PATHS ${BRLCAD_MOOSE_DIR} NO_SYSTEM_PATH PATH_SUFFIXES lib libs bin)
ELSE(CMAKE_LINK_LIBRARY_SUFFIX)
    FIND_PATH(BRLCAD_MOOSE_LIBRARY_DIR NAMES "brlcad${CMAKE_SHARED_LIBRARY_SUFFIX}" "libbrlcad${CMAKE_SHARED_LIBRARY_SUFFIX}" PATHS ${BRLCAD_MOOSE_DIR} NO_SYSTEM_PATH PATH_SUFFIXES lib libs bin)
